...
exports.registerUser = async function (userId, name) {
...
exports.connectToNetwork = async function (userName) {
    ...
    try {
        ...
        const contract = await network.getContract('inventory');
...
exports.createParticipant = async function (networkObj, id, name) {
    try {

        let response = await networkObj.contract.submitTransaction('createParticipant', id, name);
...
exports.createItem = async function (networkObj, itemId, description, owner) {
    try {

        let response = await networkObj.contract.submitTransaction('createItem', itemId, description, owner);
        await networkObj.gateway.disconnect();
        return response.toString();
    } catch (error) {
        let response = { error: 'the following errors ocurred: ' + error.message? error.message : error};
